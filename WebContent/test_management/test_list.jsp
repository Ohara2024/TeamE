...
<form id="searchForm" method="post">
    ...
    <fieldset style="border: none; padding: 10px 0; margin-bottom: 20px;">
        ...
        <button type="submit" formaction="${pageContext.request.contextPath}/testmanagement/subjectexe" style="padding: 5px 15px;">
            検索
        </button>
    </fieldset>
    ...
    <fieldset style="border: none; padding: 10px 0;">
        ...
        <button type="submit" formaction="${pageContext.request.contextPath}/testmanagement/studentexe" style="margin-left: 10px; padding: 5px 15px;">
            検索
        </button>
    </fieldset>
</form>
